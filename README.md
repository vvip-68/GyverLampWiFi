...
> Этот проект устарел. Тем, кому не нужно интерактивное управление играми, рисование на матрице и отправка картинки - 
> рекомендуется обратить внимание на более новый проект  
> ["Широкоформатная матрица / гирлянда на балкон или стену с управлением по WiFi"](https://github.com/vvip-68/GyverPanelWiFi)
