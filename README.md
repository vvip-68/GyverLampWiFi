...
### Фишки
 - 26 крутых эффекта с поддержкой отображения часов поверх эффектов
...
### Изменения функционала лампы по справнению с исходным проектом:
 ...
 - Для ламп с матрицей, свернутой в трубу доступно отображение часов с плавным вращением вокруг матрицы.   
   Таким образом часы будут полностью видны при обороте по кругу вне зависимости от кривизны поферхности плафона лампы.
