...
> Этот проект устарел. Новый проект ["Широкоформатная матрица / гирлянда на балкон или стену с управлением по WiFi"](https://github.com/vvip-68/GyverPanelWiFi)
> полностью перекрывает функционал этого проекта, а также имеет множество доработок и улучшений.
